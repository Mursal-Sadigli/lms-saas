...
export default function CreateCourse() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await createCourse(token, { ...form, videos, price: Number(form.price) })
      toast.success('Kurs uğurla yaradıldı! Dashboad rəfində "Yayımla" edərək publik edə bilərsiniz.', { duration: 5000 })
  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-10 transition-colors">
      <h1 className="text-3xl font-extrabold text-gray-900 dark:text-white mb-2">Yeni Kurs Yarat 🎓</h1>
      <p className="text-gray-500 dark:text-gray-400 mb-10">Biliklərini paylaş, tələbələrə kömək et.</p>
