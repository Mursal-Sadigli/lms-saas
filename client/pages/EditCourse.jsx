...
import { editCourse, fetchCourseById, uploadFile } from '../src/api' // Updated
...
export default function EditCourse() {
  ...
  const redirectPath = isAdmin ? '/ms/admin/123' : '/educator/dashboard'
  ...
  useEffect(() => {
    fetchCourseById(id).then(course => {
      setForm({
        ...
        price: course.price || '',
        category: course.category || 'Informatika dərs izahları',
